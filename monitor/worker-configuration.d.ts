/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 0c394c2fe98040e630804984a5219831)
// Runtime types generated with workerd@1.20260426.1 2026-06-25 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "MonitorState";
	}
	interface Env {
		EMAIL: SendEmail;
		ALERT_TO: "alerts@sosumi.ai";
		MONITOR_STATE: DurableObjectNamespace<import("./src/index").MonitorState>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALERT_TO">> {}
}
